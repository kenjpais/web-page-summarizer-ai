...
class TestFuzzyMatching(unittest.TestCase):
    ...
    def test_clean_feature_name(self):
        ...
        self.assertEqual(clean_feature_name("enable-feature-x(deprecated)"), "feature x")
        ...
        self.assertEqual(clean_feature_name("user_authentication_v2"), "user authentication v2")
    ...
    def test_clean_jira_summary(self):
        ...
        self.assertEqual(clean_jira_summary("Feature: New dashboard implementation"), "New dashboard implementation")
        
        # Test removing ticket numbers
        self.assertEqual(clean_jira_summary("PROJ-123: User authentication"), "User authentication")
        
        # Test removing brackets
        self.assertEqual(clean_jira_summary("Payment processing [URGENT]"), "Payment processing")
    ...
    def test_calculate_match_score(self):
        ...
        # Test partial match
        score = calculate_match_score("user authentication", "User authentication system version 2")
    ...
    def test_specific_matches(self):
        ...
        score = calculate_match_score("enable-new-dashboard", "Implement new dashboard feature for users")
        ...
        score = calculate_match_score("user_authentication_v2", "User authentication system version 2")
        self.assertGreater(score, 80, "Authentication feature should match with high score")
        
        # Test that "payment-processing-enhancement" matches with payment issue
        score = calculate_match_score("payment-processing-enhancement", "Payment processing improvements")
    ...
    def test_case_sensitivity(self):
        ...
        feature_to_jira = {match['feature_name']: match['jira_key'] for match in matches}
    ...
    def test_max_matches_per_feature(self):
        ...
        auth_matches = [m for m in matches if m['feature_name'] == 'user-authentication']
